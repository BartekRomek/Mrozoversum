  ...
  return (
    <div className="relative">
      ...
      <div className="relative w-[154px]">
        ...
        <article
          className={clsx(
            "group relative h-full w-full overflow-hidden border bg-[#11131a]/95 shadow-2xl transition duration-300 hover:-translate-y-1 hover:scale-[1.015] hover:border-white/25",
            isSelected
          ...
          style={{
            ...
            boxShadow: isSelected
              ? `0 0 0 2px ${seriesColors[book.series]}99, 0 22px 70px rgba(0,0,0,.58), 0 0 24px ${seriesColors[book.series]}44`
        ...
        >
          <div className="relative h-[214px] bg-[#171923]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#08090d] via-black/55 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#08090d] via-[#08090d]/92 to-transparent" />
            ...
            <div className="absolute inset-x-0 bottom-0 p-3">
              <div className="rounded-md bg-black/28 p-2 backdrop-blur-[2px]">
