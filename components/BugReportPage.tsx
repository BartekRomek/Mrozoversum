...
export function BugReportPage({ onBack }: { onBack?: () => void }) {
  ...
  return <SubpageLayout onBack={onBack} className="bug-report-page"><div className="mx-auto max-w-3xl px-5 py-12 text-[#f4f1ea] sm:px-8 sm:py-20"><header><p className="font-mono text-[10px] font-bold uppercase tracking-[0.28em] text-rose-300/70">Kontakt</p><h1 className="mt-3 text-4xl font-extrabold uppercase tracking-tight text-white sm:text-5xl">Zgłoś błąd</h1><p className="mt-5 max-w-2xl text-base leading-7 text-white/60">Znalazłeś błąd, nieścisłość lub brakujące informacje? Daj mi znać. Każde zgłoszenie pomaga rozwijać Mrozoversum.</p></header>
